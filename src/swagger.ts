...
const paginatedQuery = (extra: OpenAPIV3.ParameterObject[] = []): OpenAPIV3.ParameterObject[] => [
  { name: "page", in: "query", schema: { type: "integer", default: 1 } },
  { name: "limit", in: "query", schema: { type: "integer", default: 50, maximum: 200 } },
  ...extra,
];

const paginatedResponse = (itemSchema: OpenAPIV3.SchemaObject | OpenAPIV3.ReferenceObject): OpenAPIV3.ResponseObject => ({
  description: "OK",
  content: {
    "application/json": {
      schema: {
  ...
  paths: {
    ...
    "/ste": {
      get: {
        ...
        parameters: paginatedQuery([
          { name: "search", in: "query", description: "Поиск по названию (ilike)", schema: { type: "string" } },
          { name: "category", in: "query", description: "Фильтр по категории (ilike)", schema: { type: "string" } },
        ]),
        responses: {
    ...
    "/ste/{id}": {
      get: {
        ...
        responses: {
          "200": { description: "OK", content: { "application/json": { schema: { $ref: "#/components/schemas/Ste" } } } },
          "400": errorResponse,
          "404": errorResponse,
          "500": errorResponse,
        },
    ...
    "/contracts": {
      get: {
        ...
        parameters: paginatedQuery([
          { name: "search", in: "query", description: "Поиск по наименованию закупки (ilike)", schema: { type: "string" } },
          { name: "buyerInn", in: "query", description: "ИНН заказчика (точное совпадение)", schema: { type: "string" } },
          { name: "supplierInn", in: "query", description: "ИНН поставщика (точное совпадение)", schema: { type: "string" } },
          { name: "region", in: "query", description: "Регион заказчика (ilike)", schema: { type: "string" } },
          { name: "dateFrom", in: "query", description: "Дата заключения от (ISO 8601)", schema: { type: "string", format: "date" } },
          { name: "dateTo", in: "query", description: "Дата заключения до (ISO 8601)", schema: { type: "string", format: "date" } },
        ]),
        responses: {
    ...
    "/contracts/{id}": {
      get: {
        ...
        responses: {
          "200": {
            description: "OK",
            content: { "application/json": { schema: { allOf: [{ $ref: "#/components/schemas/Contract" }, { type: "object", properties: { items: { type: "array", items: { $ref: "#/components/schemas/ContractItemWithSte" } } } }] } } },
          },
          "400": errorResponse,
          "404": errorResponse,
          "500": errorResponse,
    ...
    "/contracts/{id}/items": {
      get: {
        ...
        parameters: [{ name: "id", in: "path", required: true, schema: { type: "integer" } }],
        responses: {
          "200": { description: "OK", content: { "application/json": { schema: { type: "array", items: { $ref: "#/components/schemas/ContractItemWithSte" } } } } },
          "400": errorResponse,
          "404": errorResponse,
          "500": errorResponse,
        },
    ...
    schemas: {
      ...
      Ste: {
        ...
        properties: {
          ...
          characteristics: { type: "string", nullable: true, description: "Формат: Ключ1:Значение1;Ключ2:Значение2;..." },
        },
      },
      Contract: {
        type: "object",
        properties: {
          ...
          initialContractValue: { type: "string", nullable: true, description: "numeric" },
          contractValueAfterSigning: { type: "string", nullable: true, description: "numeric" },
